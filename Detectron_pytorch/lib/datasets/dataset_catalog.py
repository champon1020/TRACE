...
DATASETS = {
    ...
    "coco_2014_train": {
        IM_DIR: _DATA_DIR + "/coco/images/train2014",
        ANN_FN: _DATA_DIR + "/coco/annotations/instances_train2014.json",
    },
    "coco_2014_val": {
        IM_DIR: _DATA_DIR + "/coco/images/val2014",
    ...
    "coco_2015_test": {
        IM_DIR: _DATA_DIR + "/coco/images/test2015",
    ...
    "coco_2017_train": {
        IM_DIR: _DATA_DIR + "/coco/images/train2017",
        ANN_FN: _DATA_DIR + "/coco/annotations/instances_train2017.json",
    },
    "coco_2017_val": {
        IM_DIR: _DATA_DIR + "/coco/images/val2017",
        ANN_FN: _DATA_DIR + "/coco/annotations/instances_val2017.json",
    },
    ...
    "coco_stuff_train": {
        IM_DIR: _DATA_DIR + "/coco/images/train2014",
        ANN_FN: _DATA_DIR + "/coco/annotations/stuff_train.json",
    },
    "coco_stuff_val": {
        IM_DIR: _DATA_DIR + "/coco/images/val2014",
        ANN_FN: _DATA_DIR + "/coco/annotations/stuff_val.json",
    },
    ...
    "keypoints_coco_2017_train": {
        IM_DIR: _DATA_DIR + "/coco/images/train2017",
        ANN_FN: _DATA_DIR + "/coco/annotations/person_keypoints_train2017.json",
    },
    "keypoints_coco_2017_val": {
        IM_DIR: _DATA_DIR + "/coco/images/val2017",
        ANN_FN: _DATA_DIR + "/coco/annotations/person_keypoints_val2017.json",
    },
    "keypoints_coco_2017_test": {
        IM_DIR: _DATA_DIR + "/coco/images/test2017",
        ANN_FN: _DATA_DIR + "/coco/annotations/image_info_test2017.json",
    },
    "voc_2007_train": {
        IM_DIR: _DATA_DIR + "/VOC2007/JPEGImages",
        ANN_FN: _DATA_DIR + "/VOC2007/annotations/voc_2007_train.json",
    ...
    "voc_2012_train": {
        ...
        ANN_FN: _DATA_DIR + "/VOC2012/annotations/train.json",
        DEVKIT_DIR: _DATA_DIR + "/VOC2012/VOCdevkit2012",
    },
    "voc_2012_trainval": {
        IM_DIR: _DATA_DIR + "/VOC2012/JPEGImages",
        ANN_FN: _DATA_DIR + "/VOC2012/annotations/trainval.json",
        DEVKIT_DIR: _DATA_DIR + "/VOC2012/VOCdevkit2012",
    },
    "custom_data_train": {
        IM_DIR: _DATA_DIR + "/CustomData/JPEGImages",
        ANN_FN: _DATA_DIR + "/CustomData/annotations/train.json",
        DEVKIT_DIR: _DATA_DIR + "/CustomData/CustomDataDevkit",
    },
    "custom_data_trainval": {
        IM_DIR: _DATA_DIR + "/CustomData/JPEGImages",
        ANN_FN: _DATA_DIR + "/CustomData/annotations/trainval.json",
        DEVKIT_DIR: _DATA_DIR + "/CustomData/CustomDataDevkit",
    },
    "custom_data_test": {
        IM_DIR: _DATA_DIR + "/CustomData/JPEGImages",
        ANN_FN: _DATA_DIR + "/CustomData/annotations/test.json",
        DEVKIT_DIR: _DATA_DIR + "/CustomData/CustomDataDevkit",
    },
}

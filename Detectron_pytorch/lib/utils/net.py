...
def smooth_l1_loss(
    bbox_pred, bbox_targets, bbox_inside_weights, bbox_outside_weights, beta=1.0
):
    """
...
def _CorrectMomentum(optimizer, param_keys, correction):
    ...
    for p_key in param_keys:
        if optimizer.state[p_key].__contains__("momentum_buffer"):

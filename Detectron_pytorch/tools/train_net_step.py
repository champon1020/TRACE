...
from roi_data.loader import (BatchSampler, MinibatchSampler, RoiDataLoader,
                             collate_minibatch)
...
def main():
    ...
    assert (gn_param_nameset - set(nograd_param_names) - set(bias_param_names)) == set(
        gn_param_names
    )

    # Learning rate of 0 is a dummy value to be set properly at the start of training
    params = [
        {"params": nonbias_params, "lr": 0, "weight_decay": cfg.SOLVER.WEIGHT_DECAY},
        {
            "params": bias_params,

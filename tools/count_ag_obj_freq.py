...
if __name__ == "__main__":
    ...
    category_counter_test = process_vrd_split(
        "test", "val", test_split, obj_dict, pred_dict
    )
    category_counter_train = process_vrd_split(
        "train", "train", train_split, obj_dict, pred_dict
    )

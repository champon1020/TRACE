...
def get_glob_rel_mat(num_prd_classes, is_multi_relation=True, f_path=None):
    ...
    rel_mat_cou = np.zeros((num_prd_classes, num_prd_classes), dtype=np.float32)
...
if __name__ == "__main__":
    n_x, n_y, p_x, p_y, a, rel_mat_cou = get_glob_rel_mat(
        26, f_path="./data/ag/annotations/new_annotations_train.json"
    )

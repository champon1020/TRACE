...
class GenerateRelProposalLabelsOp(nn.Module):
    ...
    def forward(
        ...
        json_dataset_rel.add_rel_proposals(
            roidb,
            sbj_rois,
            obj_rois,
            det_rois,
        ...
        output_blob_names = [
            ...
            "rel_rois",
            "fg_prd_labels_int32",
            "all_prd_labels_int32",
            "fg_size",
            "sbj_inds",
            "obj_inds",
            "det_labels",
            "multi_prd_labels_int32",
            "keep_pair_class_int32",
        ]
        ...
        if (
            ...
            output_blob_names += [
                "binary_labels_sbj_pos_int32",
                "sbj_rois_sbj_pos",
                "obj_rois_sbj_pos",
                "rel_rois_sbj_pos",
                "spt_feat_sbj_pos",
                "sbj_labels_sbj_pos_int32",
                "obj_labels_sbj_pos_int32",
                ...
                "rel_rois_obj_pos",
                "spt_feat_obj_pos",
                "sbj_labels_obj_pos_int32",
                "obj_labels_obj_pos_int32",

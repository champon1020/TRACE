...
__C.MODEL.RUN_RELDN = False
__C.MODEL.RUN_GRAPHRCNN = False
__C.MODEL.VCTREE = False
...
__C.MODEL.MULTI_RELATION = False
...
__C.FPN.FREEZE_FPN = True

__C.FPN.REL_FPN_ON = False
...
# ---------------------------------------------------------------------------- #
# For video dataset, such as Action Genome
# ---------------------------------------------------------------------------- #
# The half number of frames to process
__C.HALF_NUMBER_OF_FRAMES = 3
...
__C.RESIZE_HIDDEN_DIM = 1

__C.ENABLE_SAMPLE_TRAIN = False

__C.USE_BASELINE = AttrDict()
__C.USE_BASELINE.FULL_GRAPH_MSP = False

__C.VECTOR_RESPONSE = False
__C.FREEZE_PART_I3D = False
__C.FREEZE_ALL_I3D = False

__C.USE_TWO_STREAM = False

__C.DISABLE_EMBED = False
__C.MSP_GROUP = 4
__C.MSP_MAX_TREE_HEIGHT = 7
__C.CLUSTER_NUM_PARTITION = 2.0
